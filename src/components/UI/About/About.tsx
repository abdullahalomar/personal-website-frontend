...
const About = () => {
  return (
    // <div className="flex justify-between items-center gap-28 px-24 my-10">
    //   <div className="relative">
    //     <Image src={profile} height={500} width={500} alt="about image" />

    //     <button className="uppercase absolute -bottom-10 -right-10 bg-blue-400 py-5 px-8 flex gap-3">
    //       Download CV{" "}
    //       <Image src={download} height={20} width={20} alt="download" />
    //     </button>
    //   </div>
    //   <div className="mt-20 sm:mt-20">
    //     <p className="uppercase text-xl text-blue-500">About me</p>
    //     <h1 className="text-5xl my-5">I Develop System that Works</h1>
    //     <p className="text-xl">
    //       Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quae officia
    //       temporibus inventore eligendi, quidem repudiandae quam dolor obcaecati
    //       ab fugiat!
    //     </p>
    //     <hr className="my-8" />
    //     <div className="flex">
